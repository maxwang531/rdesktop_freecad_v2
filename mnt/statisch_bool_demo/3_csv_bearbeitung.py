...
SsdNetfile = '/config/eingabe_model/csv_file/vorfuhrung_2_common.csv'
freeCADfile = '/config/eingabe_model/csv_file/Modelldaten_vorfuhrung_2_common.csv'
resultfile = '/config/eingabe_model/csv_file/vorfuhrung_2_common_Result.csv'
...
#print(corpusData.loc[0]['x-'])#只对DataFrame进行操作 https://www.datacamp.com/community/tutorials/pandas-tutorial-dataframe-python#question2
#print(corpusData.iloc[0][0])
#print(corpusData.iloc[0][1])
#print(corpusData['type'])
#print(corpusData.iloc[0:y,7])
#print(x)
#print(y)
