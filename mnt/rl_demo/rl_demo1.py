...
#fileinformation
filepath = '/config/eingabe_model/demo1.FCStd'
file_name_1 = 'demo1'
file_name_2 = "demo1"
...
toolpath3 = "/usr/lib/freecad/Mod/Path/Tools/Bit/317mm_Ball_End.fctb"
toolpath4 = "/usr/lib/freecad/Mod/Path/Tools/Bit/317mm_long_Ball_End.fctb"
...
tool1_diameter = werkzeug(toolpath1, 'tool1') #157mm_endmill
...
tool3_diameter = werkzeug(toolpath3, 'tool3') #ballend
App.getDocument(file_name_1).getObject('ToolBit003').ShapeName = "ballend"
tool4_diameter = werkzeug(toolpath3, 'tool4') #ballend
App.getDocument(file_name_1).getObject('ToolBit004').ShapeName = "ballend"
DOC.recompute()
werkzeuglist = ['tool1','tool2','tool3','tool4']
werkzeugdiameter = [tool1_diameter,tool2_diameter,tool3_diameter,tool4_diameter]
