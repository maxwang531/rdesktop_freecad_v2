...
#fileinformation
filepath = '/config/mnt/rl_demo/model/curved_surface3.FCStd'
file_name_1 = 'curved_surface3'
file_name_2 = "curved_surface3"
...
face_anzahl_list = obj.Shape.Faces #打印模型面的信息 一个6个面
face_type_list = []
face_volume_list = []
for i in range(0,len(face_anzahl_list)):
    face_type = App.ActiveDocument.Part__Feature.Shape.Faces[i].Surface.TypeId
    face_volume = App.ActiveDocument.Part__Feature.Shape.Faces[i].Volume
    face_type_list.append(face_type)
    face_volume_list.append(face_volume)
#print("face_type:",face_type_list) #['Part::GeomPlane', 'Part::GeomBSplineSurface', 'Part::GeomPlane', 'Part::GeomBSplineSurface', 'Part::GeomBSplineSurface', 'Part::GeomBSplineSurface']
#print("face_volume:",face_volume_list) #[2.1665506317443727e-14, -7.133333333333165e-14, -9.573152053588208e-14, 4.9994389768219664e-11, 3230.039586387739, 7.53472533333307e-11]
...
#print(select_face_id) #[5]
#print(select_face) #['Face5']
...
def zielteil_export():
    Gui.Selection.addSelection(file_name_1, 'Part__Feature')
    __objs__ = []
    __objs__.append(App.getDocument(file_name_2).getObject("Part__Feature"))
...
#print(len(zielteil_voxel_anzahl)) #69954
#print("Ziel_voxel:",len(zielteil_voxel_list_xyz)) #69954
stl_binvox_delete()
'''Rohteil-Zielteil'''
...
#print("unterschiedlistlänge:", len(unterschied_list)) #9918
...
tool1_diameter = werkzeug(toolpath1, 'tool1') #5mm_endmill
tool2_diameter = werkzeug(toolpath2, 'tool2') #8mm_endmill
App.getDocument('curved_surface3').getObject('ToolBit002').ShapeName = "endmill"
DOC.recompute()
...
class MyEnv(Env):
    def __init__(self):
        ...
        self.werkzeugdiameter = [tool1_diameter,tool2_diameter]
...
'''该程序只选取了两种刀具，5mmEndmill，8mmEndmill，选取多种布线方式line，主要学习stepover，stepdown=5 '''

# Create save dir
save_dir = "/config/training_data/rl_model/"
...
model.save(save_dir + "/ppo_Myenv_64_1000_curved_bat_gamma0_1")

App.closeDocument("curved_surface3")
Gui.doCommand('exit()')
